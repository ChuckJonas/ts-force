import { RestObject, SObject, sField, PolyRestObject } from '../../src/index';
/**
...
export class Account extends RestObject  implements AccountFields {
    ...
    sLAExpirationDate: Date;
    @sField({ apiName: 'Formula_Test__c', readOnly: true, required: false, reference: undefined, childRelationship: false, salesforceType: 'string' })
    formulaTest: string;
